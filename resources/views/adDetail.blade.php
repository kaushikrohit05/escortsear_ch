...
<div class="col-md-3">
    <div class="d-grid gap-3 mt-5">
        ...
        <a class="btn btn-success" href="https://wa.me/91{{ $ads['phone'] }}?text=Hi! I saw your ad {{ $ads['title'] }} on EscortSear.ch" role="button" target="_blank"><i class="fab fa-whatsapp"></i> WhatsApp</a>
        @endif
