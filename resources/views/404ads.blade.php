...
<div class="row my-3 breadcrumb"><div class="col small"><a href="/"><i class="fas fa-home"></i></a> > 
    ...
    <div class="row"><div class="col text-center my-5 py-5">
        <h1>Oops!</h1>
        <h2>Your search returned no results.</h2>
<div>Luckily, there are a lot of other 
options for you 😎</div></div></div>
           ...
           <!-- <div class="card">
                <div class="card_body"> -->
                  <div class="row ad_card1">
                      ...
                      <div class="col-8 col-md-10 col-sm-9 "><!--<h3><a href="/ad/{{ $ad['id'] }}">{{ $ad['title'] }}</a></h3>-->
                      <div class="py-2">
                        <h3 class="post_title"><a href="/{{ $ad['category_slug'] }}/{{ $ad['location_slug'] }}/{{ $ad['title_slug'] }}">{{ $ad['title'] }}</a></h3>
                        <div class="post_desc">{{ Str::limit(str_replace('&nbsp;', ' ',strip_tags($ad['description'])), 200) }}</div>
                         </div> 

                        


                        <div class="small "><strong>{{ $ad->user_age }} YEARS | {{ $ad->category }} </strong>|  
  ...
  <div class="row mt-5">
    <div class="col-md-12">
      @if($s_location)
      <div class="text-center mb-5"><h2>Browse {{ $s_category->category }} Ads in {{ $s_location->location }}</h2></div>
...
@endif
@if(!$s_location)
<div class="text-center mb-5"><h2>Browse {{ $s_category->category }} Ads in India</h2></div>
